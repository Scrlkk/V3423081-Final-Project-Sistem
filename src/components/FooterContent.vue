...
<template>
  <footer class="bg-x-black text-white pt-12">
    <div class="container mx-auto">
      <div class="px-12 flex justify-between items-center mb-6">
      ...
      <div class="mx-12 py-8 bg-gray-400 bg-opacity-10 mb-6 space-y-4">
        <div class="px-16 py-6 grid grid-cols-2">
          <div class="text-3xl font-bold text-white">
            Subscribe to our newsletter to get <br />
            latest updates and news
          </div>

          <div class="flex space-x-6 items-center h-min">
            <input
              type="email"
              placeholder="Enter Your Email"
              class="w-full px-6 py-3 bg-transparent border border-gray-600 text-white focus:outline-none"
            />
            <button
              class="px-12 py-3 bg-blue-600 text-white hover:bg-x-yellow transition duration-150 ease-in-out"
