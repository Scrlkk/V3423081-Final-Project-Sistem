...
<template>
  <section class="flex flex-col items-center px-20 mt-5 w-full">
    <!-- TITLE -->
    <h2
      class="self-center mt-32 text-4xl font-bold tracking-tighter leading-none text-gray-800"
    >
      List of Authors
    </h2>

    <!-- ISI -->
    <div class="self-stretch mt-12">
      <div class="flex gap-5">
        <!-- 1 -->
        <article
          class="flex flex-col w-3/12 shadow hover:shadow-xl hover:-translate-y-5 transition duration-150 ease-in-out"
        >
          <router-link to="/Author">
            <div
              class="flex flex-col grow items-center px-14 py-10 w-full leading-none bg-zinc-100 hover:bg-orange-50"
            >
              <img
                loading="lazy"
                src="@/assets/images/misc/Author1.png"
                class="object-cover w-32 max-w-full rounded-full aspect-square"
              />
              <h3
                class="mt-5 text-3xl font-bold tracking-tighter text-gray-800"
              >
                Floyd Miles
              </h3>
              <p
                class="font-inter self-stretch text-sm text-center text-zinc-500 py-2"
              >
        ...
        >
          <router-link to="/Author">
            ...
            >
              <img
                loading="lazy"
                src="@/assets/images/misc/Author2.png"
                class="object-cover w-32 max-w-full rounded-full aspect-square"
              />
              <h3
                class="mt-5 text-3xl font-bold tracking-tighter text-gray-800"
        ...
        >
          <router-link to="/Author">
            ...
            >
              <img
                loading="lazy"
                src="@/assets/images/misc/Author3.png"
                class="object-cover w-32 max-w-full rounded-full aspect-square"
              />
              <h3
                class="mt-5 text-3xl font-bold tracking-tighter text-gray-800"
        ...
        <!-- 4 -->
        <article
          class="shadow flex flex-col w-3/12 hover:shadow-xl hover:-translate-y-5 transition duration-150 ease-in-out"
        >
          <router-link to="/Author">
            <div
              class="flex flex-col grow items-center px-14 py-10 w-full leading-none bg-zinc-100 hover:bg-orange-50"
            >
              <img
                loading="lazy"
                src="@/assets/images/misc/Author4.png"
                class="object-cover w-32 max-w-full rounded-full aspect-square"
              />
              <h3
                class="mt-5 text-3xl font-bold tracking-tighter text-gray-800"
