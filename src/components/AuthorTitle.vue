...
import Author from '@/assets/images/misc/author.png'

</script>

<template>
  <section class="relative bg-[#F4F0F8] pt-52 pb-32">
    <div class="max-w-5xl mx-auto">
      <div class="items-start flex  gap-8">
        <!-- KIRI -->
        <img :src="Author" />
        ...
        <div>
          <div>
            <h1
              class="font-sen text-5xl font-bold text-gray-900 leading-snug tracking-tighter"
            >
              Hey there, I.'m Andrew Jonhson and welcome to my Blog
            </h1>
            <p
              class="max-w-2xl mt-5 mb-6 text-m font-inter leading-7 text-[#6D6E76]"
            >
    ...
    <div
      class="absolute max-w-5xl bottom-0 py-3 bg-[#FFD050] w-full left-1/2 transform -translate-x-1/2 z-10"
    ></div>
  </section>
</template>
