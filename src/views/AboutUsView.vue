...
import Post from '@/components/AboutUsTeam.vue'
import Post2 from '@/components/AboutUsBlog.vue'
import ListAuthor from '@/components/ListAuthor.vue'
...
<template>
  <MainLayout>
    ...
    <section class="px-20 mb-32">
      <div class="self-stretch mt-7">
        <div class="flex gap-5">
          <!-- 5 -->
          <article
            class="flex flex-col w-3/12 hover:-translate-y-5 transition duration-150 ease-in-out"
          >
            <router-link to="/Author">
              ...
              >
                <img
                  loading="lazy"
                  src="@/assets/images/misc/Author5.png"
                ...
                <p class="self-stretch text-sm text-center text-zinc-500 py-2">
          ...
          >
            <router-link to="/Author">
              ...
              >
                <img
                  loading="lazy"
                  src="@/assets/images/misc/Author6.png"
                  class="object-cover w-32 max-w-full rounded-full aspect-square"
                />
                <h3
                  class="mt-5 text-3xl font-bold tracking-tighter text-gray-800"
          ...
          >
            <router-link to="/Author">
              ...
              >
                <img
                  loading="lazy"
                  src="@/assets/images/misc/Author7.png"
                  class="object-cover w-32 max-w-full rounded-full aspect-square"
                />
                <h3
                  class="mt-5 text-3xl font-bold tracking-tighter text-gray-800"
          ...
          >
            <router-link to="/Author">
              ...
              >
                <img
                  loading="lazy"
                  src="@/assets/images/misc/Author8.png"
                  class="object-cover w-32 max-w-full rounded-full aspect-square"
                />
                <h3
                  class="mt-5 text-3xl font-bold tracking-tighter text-gray-800"
